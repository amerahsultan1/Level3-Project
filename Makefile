...
shipping:   
	kubectl create -f payment/tkn-docker/sa-shipping.yaml -n test -f payment/tkn-docker/PipelineResource-shipping.yaml -n test -f payment/tkn-docker/task-shipping.yaml -n test -f payment/tkn-docker/TaskRun-shipping.yaml -n test
